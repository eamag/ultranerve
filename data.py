...
def create_train_data():
    ...
    not_empty = 2323  # count that for you, imgs that have masks
    ...
    for image_name in images:
        ...
        if number_of_colors(os.path.join(train_data_path, image_mask_name)) == 1:
            continue
        img = np.array([img])
        ...
        if i % 100 == 0:
            print('Done: {0}/{1} images'.format(i, not_empty))
        i += 1
    print('Loading done.')
