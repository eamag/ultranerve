...
from keras.layers import Input, merge, Convolution2D, MaxPooling2D, UpSampling2D, Dense, Flatten
...
def train_and_predict():
    ...
    print('-' * 30)
    model = get_unet()
    model_checkpoint = ModelCheckpoint('unet_class.hdf5', monitor='loss', save_best_only=True)
